...
@Component({
  ...
  styleUrls: ['./list-thematique.component.scss']
})
export class ListThematiqueComponent implements OnInit {
    ...
    get ArrayThematique(): Array<Thematique> {
        return this.service.ArrayThematique;
    }

    set ArrayThematique(value: Array<Thematique>) {
        this.service.ArrayThematique = value;
    }
    ngOnInit(): void {
        if(this.User.username== null){
            this.router.navigate(['/pages/error']);
        }
        this.service.getThematique().subscribe(
            data => {
    ...
    public EditeThem(them: Thematique) {
        this.Thematique = them;
        this.submittedCritere = false;
        this.createDialogEditeThem = true;

    }
    public addThem(){
        this.createDialogThem = true;
    }
